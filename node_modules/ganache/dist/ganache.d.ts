...
export declare class EthereumProvider extends Emittery<{
    ...
    _requestRaw<Method extends RequestMethods>({ method, params }: RequestParams<Method>): Promise<{
        value: Promise<ReturnType<EthereumApi[Method]> extends Promise<infer X> ? Externalize<X> : never>;
    }>;
    /**
...
declare type Externalize<X> = X extends Primitives ? X : X extends Quantity | Data | ITraceData ? string : {
...
declare type Hardfork_4 = "constantinople" | "byzantium" | "petersburg" | "istanbul" | "muirGlacier" | "berlin" | "london" | "arrowGlacier" | "grayGlacier";
...
declare const HARDFORKS: readonly ["constantinople", "byzantium", "petersburg", "istanbul", "muirGlacier", "berlin", "london", "arrowGlacier", "grayGlacier"];
...
declare const Params: {
     ...
     * are listed here.
     */
    TRANSACTION_DATA_NON_ZERO_GAS: Map<"chainstart" | "homestead" | "dao" | "tangerineWhistle" | "spuriousDragon" | "byzantium" | "constantinople" | "petersburg" | "istanbul" | "muirGlacier" | "berlin" | "london" | "arrowGlacier" | "grayGlacier", bigint>;
    /**
...
declare class Transaction_2 extends BaseTransaction_2<Transaction_2> {
     ...
     */
    static fromRlpSerializedTx(serialized: Buffer, opts?: TxOptions): Transaction_2;
    /**
     * Create a transaction from a values array.
     *
     * Format: `[nonce, gasPrice, gasLimit, to, value, data, v, r, s]`
     ...
     */
    protected _processSignature(v: number, r: Buffer, s: Buffer): Transaction_2;
    /**
     * Returns an object with the JSON representation of the transaction.
     */
    toJSON(): JsonTx;
