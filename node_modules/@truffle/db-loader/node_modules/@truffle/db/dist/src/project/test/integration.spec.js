...
const debug = (0, logger_1.logger)("db:project:test:integration");
...
const AddProjects = (0, graphql_tag_1.default) `
...
`;
const AddNameRecords = (0, graphql_tag_1.default) `
...
`;
const AssignProjectNames = (0, graphql_tag_1.default) `
...
`;
const ResolveProjectName = (0, graphql_tag_1.default) `
...
`;
const AddContracts = (0, graphql_tag_1.default) `
...
`;
const GetWorkspaceBytecode = (0, graphql_tag_1.default) `
...
`;
const GetWorkspaceSource = (0, graphql_tag_1.default) `
...
`;
const GetWorkspaceContract = (0, graphql_tag_1.default) `
...
`;
const GetWorkspaceCompilation = (0, graphql_tag_1.default) `
...
`;
const GetWorkspaceContractInstance = (0, graphql_tag_1.default) `
...
describe("Compilation", () => {
    ...
    beforeAll(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        sourceIds = artifacts.map(artifact => ({
            id: (0, system_1.generateId)("sources", {
                contents: artifact["source"],
                sourcePath: artifact["sourcePath"]
            })
        }));
        bytecodeIds = artifacts.map(artifact => ({
            id: (0, system_1.generateId)("bytecodes", compile_common_1.Shims.LegacyToNew.forBytecode(artifact["bytecode"]))
        }));
        callBytecodeIds = artifacts.map(artifact => ({
            id: (0, system_1.generateId)("bytecodes", compile_common_1.Shims.LegacyToNew.forBytecode(artifact["deployedBytecode"]))
        }));
        expectedSolcCompilationId = (0, system_1.generateId)("compilations", {
            compiler: artifacts[0].compiler,
            sources: [sourceIds[0], sourceIds[1], sourceIds[2]]
        });
        expectedVyperCompilationId = (0, system_1.generateId)("compilations", {
            compiler: artifacts[3].compiler,
            sources: [sourceIds[3]]
        });
        compilationIds.push({ id: expectedSolcCompilationId }, { id: expectedVyperCompilationId });
        expectedProjectId = (0, system_1.generateId)("projects", {
        ...
        yield Promise.all(artifacts.map((contract, index) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            let bytecodeId = (0, system_1.generateId)("bytecodes", shimBytecodeObject);
            // @ts-ignore won't be updefined
            let contractId = (0, system_1.generateId)("contracts", {
            ...
            if (networksArray.length > 0) {
                ...
                const netId = (0, system_1.generateId)("networks", {
                    networkId: networkId,
                ...
                const contractInstanceId = (0, system_1.generateId)("contractInstances", {
        ...
        previousContractExpectedId = (0, system_1.generateId)("contracts", {
            name: "Migrations",
            abi: { json: JSON.stringify(artifacts[1].abi) }
        });
