...
const debug = (0, logger_1.logger)("db:project:test:artifacts");
...
class ArtifactsLoader {
    ...
    load(result) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const project = yield (0, project_1.initialize)({
                project: {
    ...
    collectArtifacts(project, contractIdObjects) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const contracts = yield project.run(process_1.resources.find, "contracts", ids, (0, graphql_tag_1.default) `
      ...
      `);
            ...
            return contracts.map((contract) => {
                ...
                artifact.db = {
                    contract: (0, resources_1.toIdObject)(contract),
                    callBytecode: (0, resources_1.toIdObject)(callBytecode),
                    createBytecode: (0, resources_1.toIdObject)(createBytecode)
                };
                return artifact;
            });
        });
