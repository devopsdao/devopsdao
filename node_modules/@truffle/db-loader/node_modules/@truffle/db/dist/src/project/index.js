...
const debug = (0, logger_1.logger)("db:project");
const Process = __importStar(require("../process"));
const resources_1 = require("../resources");
const Network = __importStar(require("../network"));
const Batch = __importStar(require("./batch"));
exports.Batch = Batch;
const Initialize = __importStar(require("./initialize"));
exports.Initialize = Initialize;
const AssignNames = __importStar(require("./assignNames"));
exports.AssignNames = AssignNames;
const LoadCompile = __importStar(require("./loadCompile"));
exports.LoadCompile = LoadCompile;
const LoadMigrate = __importStar(require("./loadMigrate"));
...
class ConnectedProject extends Project {
    ...
    loadMigrate(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return {
                network: (0, resources_1.toIdObject)(network.knownLatest),
                artifacts
            };
        });
    }
    populateNetworks(options) {
        ...
        return artifacts.map((artifact, index) => {
            ...
            return Object.assign(Object.assign({}, artifact), { networks: Object.assign(Object.assign({}, artifact.networks), { [networkId]: Object.assign(Object.assign({}, (artifact.networks || {})[networkId]), { db: {
                            network: networks[index] || (0, resources_1.toIdObject)(knownLatest)
                        } }) }) });
        });
    }
}
