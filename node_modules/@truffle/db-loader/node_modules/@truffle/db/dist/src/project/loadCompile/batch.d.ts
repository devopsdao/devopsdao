...
export declare namespace Compilations {
    ...
    const configure: <C extends Config>(options: Options<C>) => <I extends Compilation<C>, O extends Common.Compilation & C["compilation"] & {
        contracts: Contract<C>[];
        sources: Source<C>[];
    } & {
        db: Resources<C>;
...
export declare namespace Contracts {
    ...
    const configure: <C extends Config>(options: Options<C>) => <I extends Contract<C>, O extends Common.CompiledContract & C["contract"] & {
        db: Resources<C>;
    }>(inputs: import("hkts/src").$<Omit<Common.Compilation, "contracts"> & C["compilation"] & {
        contracts: (Common.CompiledContract & _)[];
    }, [I]>[]) => Generator<import("../../meta/process/types").GraphQlRequest | import("../../meta/process/types").Web3Request, import("hkts/src").$<Omit<Common.Compilation, "contracts"> & C["compilation"] & {
        contracts: (Common.CompiledContract & _)[];
    }, [I & O]>[], any>;
}
