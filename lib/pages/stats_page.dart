...
class _TotalOverviewCardsState extends State<TotalOverviewCards> {
  final Map<String, bool> _expandedOtherCards = {};
              ...
              children: [
                ...
                if (otherGroupEntries.isNotEmpty)
                  ExpansionTile(
                    ...
                    initiallyExpanded: _expandedOtherCards[groupTitle] ?? false,
                    onExpansionChanged: (isExpanded) {
                      setState(() {
                        _expandedOtherCards[groupTitle] = isExpanded;
                      });
                    },
                  ),
                if (_expandedOtherCards[groupTitle] == true)
                  ...otherGroupEntries.map((innerEntry) {
                    return _buildStatisticsCard(
                      title: innerEntry.key,
                      value: innerEntry.value.toString(),
                      color: Colors.blue,
