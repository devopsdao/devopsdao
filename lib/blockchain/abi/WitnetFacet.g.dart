...
class WitnetFacet extends _i1.GeneratedContract {
  ...
  Future<String> postRequest$2(
    ...
    assert(checkSignature(function, '9d44f209'));
    final params = [
      taskAddress,
      _args,
    ];
