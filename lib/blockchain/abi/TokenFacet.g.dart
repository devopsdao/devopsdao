...
class TokenFacet extends _i1.GeneratedContract {
  ...
  Future<String> mint(
    ...
    assert(checkSignature(function, '6a627842'));
    final params = [to];
    return write(
      credentials,
      transaction,
