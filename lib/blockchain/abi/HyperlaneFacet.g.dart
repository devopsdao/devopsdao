...
class HyperlaneFacet extends _i1.GeneratedContract {
  ...
  Future<String> createTaskContractHyperlane(
    ...
    assert(checkSignature(function, 'fc8b314d'));
    final params = [
      _sender,
      _nanoId,
      _taskType,
