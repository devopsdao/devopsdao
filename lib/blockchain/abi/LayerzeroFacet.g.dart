...
class LayerzeroFacet extends _i1.GeneratedContract {
  ...
  Future<bool> contractLayerzeroFacet({
    _i1.BlockNum? atBlock,
    _i1.EthereumAddress? sender,
  }) async {
    final function = self.abi.functions[0];
    assert(checkSignature(function, '9fbc3870'));
    final params = [];
  ...
  Future<String> createTaskContractLayerzero(
    ...
    assert(checkSignature(function, 'decb6e13'));
    final params = [
      _sender,
      _taskData,
    ];
