...
class TaskDataFacet extends _i1.GeneratedContract {
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<List<_i1.EthereumAddress>> getTaskContractsByAuditState(
    String _taskAuditState, {
    _i1.BlockNum? atBlock,
    _i1.EthereumAddress? sender,
  }) async {
    final function = self.abi.functions[8];
    assert(checkSignature(function, '11da750a'));
    final params = [_taskAuditState];
    final response = await read(
      sender,
      function,
      params,
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<List<_i1.EthereumAddress>> getTaskContractsByAuditStateLimit(
    String _taskAuditState,
    BigInt offset,
    BigInt limit,
    ...
    assert(checkSignature(function, 'b395b977'));
    final params = [
      _taskAuditState,
      offset,
      limit,
