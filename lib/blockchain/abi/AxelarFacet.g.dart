...
class AxelarFacet extends _i1.GeneratedContract {
  ...
  Future<String> createTaskContractAxelar(
    ...
    assert(checkSignature(function, '034fd52f'));
    final params = [
      _sender,
      _nanoId,
      _taskType,
