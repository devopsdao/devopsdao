...
class WormholeFacet extends _i1.GeneratedContract {
  ...
  Future<bool> contractWormholeFacet({
    _i1.BlockNum? atBlock,
    _i1.EthereumAddress? sender,
  }) async {
    final function = self.abi.functions[1];
    assert(checkSignature(function, '77f1b3b7'));
    final params = [];
  ...
  Future<String> createTaskContractWormhole(
    ...
    assert(checkSignature(function, 'e08f9624'));
    final params = [
      _sender,
      _taskData,
    ];
