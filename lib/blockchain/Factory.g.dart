...
class Factory extends _i1.GeneratedContract {
  ...
  /// set by the contract.
  Future<String> createJobContract(String _nanoId, String _title,
      String _description, String _symbol, BigInt _amount,
      {required _i1.Credentials credentials,
      _i1.Transaction? transaction}) async {
    final function = self.abi.functions[4];
    assert(checkSignature(function, '7f7d7e6c'));
    final params = [_nanoId, _title, _description, _symbol, _amount];
