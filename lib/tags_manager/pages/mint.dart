          ...
          child: Column(
            children: [
                ...
                child: Consumer<SearchServices>(builder: (context, model, child) {
                  return TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      labelText: 'Tag name',
                      labelStyle: TextStyle(fontSize: 17.0, color: Colors.grey[300]),
                      hintText: '[Find a tag or create a new one..]',
                      hintStyle: TextStyle(fontSize: 14.0, color: Colors.grey[300]),
                      // focusedBorder: const UnderlineInputBorder(
                      //   borderSide: BorderSide.none,
                      // ),
                    ),
                    style: DodaoTheme.of(context).bodyText1.override(fontFamily: 'Inter', color: Colors.grey[300]),
                    minLines: 1,
                    maxLines: 1,
                  );
                }),
              ...
              Stack(alignment: Alignment.bottomCenter, children: [
                    ...
                    return Wrap(
                        ...
                        children: model.tagsFilterResults.entries.map((e) {
                          if (!tagsCompare.containsKey(e.value.tag)) {
                            if (e.value.selected) {
                              tagsCompare[e.value.tag] = TagsCompare(
                                state: 'remain',
                              );
                            } else {
                              tagsCompare[e.value.tag] = TagsCompare(
                ...
                Consumer<ManagerServices>(builder: (context, model, child) {
                  late double secondPartHeight = 0.0;
                  late bool splitScreen = false;
