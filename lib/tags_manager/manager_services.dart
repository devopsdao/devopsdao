...
class ManagerServices extends ChangeNotifier {
  late NftTagsBunch treasuryNftsInfoSelected = NftTagsBunch(tag: 'empty', bunch: { 0 : SimpleTags(collection: true, tag: 'empty')});
  ...
  Future<void> clearSelectedInManager() async {
    treasuryNftsInfoSelected = NftTagsBunch(tag: 'empty', bunch: { 0 : SimpleTags(collection: true, tag: 'empty')});
