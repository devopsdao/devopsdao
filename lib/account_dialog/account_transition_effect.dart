  ...
  Widget build(BuildContext context) {
    ...
    return OpenContainer(
      ...
      openBuilder: (BuildContext context, VoidCallback _) {
        ...
        tasksServices.accountsTemp.values.toList()[index].walletAddress.toString();
        RouteInformation routeInfo = RouteInformation(location: '/$fromPage/$taskAddress');
        Beamer.of(context).updateRouteInformation(routeInfo);
        return AccountFuture(
          fromPage: fromPage,
          taskAddress: tasksServices.accountsTemp.values.toList()[index].walletAddress,
          shimmerEnabled: true,
        );
      },
      ...
      closedBuilder: (BuildContext context, VoidCallback openContainer) {
        return AccountItem(
          fromPage: fromPage,
          object: tasksServices.accountsTemp.values.toList()[index],
        );
      },
    );
  }
