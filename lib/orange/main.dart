...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyOrangePage(title: 'Wallet Connect'),
    );
  }
}

class MyOrangePage extends StatefulWidget {
  MyOrangePage({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  _MyOrangePageState createState() => _MyOrangePageState();
}
...
class _MyOrangePageState extends State<MyOrangePage> {
